...
RE_COLUMN_MATCH = re.compile(ur"\s*:".format(**CHARS))
RE_COLUMN_SUB = ur"{NBSP}:".format(**CHARS)
...
class Filter(_base.Filter):
    ...
    >>>
    >>> string = u"Oui! Non  ? Regardez: un chien  ; un chat. 55 % 45%"
    ...
    def __iter__(self):
        for token in _base.Filter.__iter__(self):
            ...
            if type == "Characters":
                ...
                text = RE_COLUMN_MATCH.sub(RE_COLUMN_SUB, text)
